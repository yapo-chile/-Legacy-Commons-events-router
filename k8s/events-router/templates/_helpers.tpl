...
Common labels
*/}}
{{- define "events-router.labels" -}}
app.kubernetes.io/name: {{ include "events-router.name" . }}
helm.sh/chart: {{ include "events-router.chart" . }}
...
*/}}
{{- define "events-router.hostPrefix" -}}
